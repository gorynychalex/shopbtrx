...
$APPLICATION->SetPageProperty("title", "Drinks & Snaks");
$APPLICATION->SetTitle("Drinks & Snaks");
...
?><?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"COMPATIBLE_MODE" => "Y",
		"COMPONENT_TEMPLATE" => "catalog_goods",
		"CONVERT_CURRENCY" => "N",
...
<script type="text/javascript">
	...
	app.setPageTitle({"title" : "Snaks & Drinks"});
</script>
...
<script type="text/javascript">
	app.addButtons({menuButton: {
		...
		callback: function()
		{
			app.openNewPage("<?=SITE_DIR?>mobile_app/personal/cart/");
		}
	}});
